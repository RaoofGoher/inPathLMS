...
const DelayedLoader = ({isLoading, delay = 300, slowLoadingThreshold = 2000 }) => {
  ...
  return (
    showLoader && (
      ...
      <div
        className={`inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-blueColor  border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite]`}
        role="status">
        <span
