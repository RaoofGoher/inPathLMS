      ...
      <form onSubmit={formik.handleSubmit}>
          ...
          <>
            ...
            <div>
              ...
              {formik.touched.discount_percentage && formik.errors.discount_percentage && (
                <p className="text-red-500 text-sm">{formik.errors.discount_percentage}</p>
              )}
            </div>
            <div>
              ...
              <input
                ...
                className="w-full border p-2 rounded focus:outline-none focus:ring-2 focus:ring-secondaryColor"
              />
              {formik.touched.discount_end_date && formik.errors.discount_end_date && (
                <p className="text-red-500 text-sm">{formik.errors.discount_end_date}</p>
              )}
            </div>
          </>
        )}
        ...
        {step === 4 && (
          <>
            ...
            <div>
              <label className="block mb-2 font-medium">Intro Video</label>
              <input
                type="file"
                name="intro_video"
                accept="video/*"
                onChange={(e) => formik.setFieldValue("intro_video", e.target.files[0])}
                onBlur={formik.handleBlur}
                className="w-full border p-2 rounded focus:outline-none focus:ring-2 focus:ring-secondaryColor"
              />
