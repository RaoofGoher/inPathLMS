              ...
              <Form>
                <div className="mb-4">
                  <Field
                    type="email"
                    name="email"
                    className="h-[60px] mt-1 p-2 block w-full border border-primaryColor bg-[#ECEBE9] focus:ring focus:ring-opacity-50"
                ...
                <div className="mb-4">
                  <Field
                    type="password"
                    name="password"
                    className="h-[60px] mt-1 p-2 block w-full border bg-[#ECEBE9] border-primaryColor shadow-sm focus:ring focus:ring-opacity-50"
